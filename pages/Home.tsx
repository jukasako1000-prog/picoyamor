          ...
          <div className="relative w-full min-h-[480px] md:min-h-[620px] rounded-[3rem] overflow-hidden group shadow-2xl bg-[#E8E1D6]">
            {HERO_SLIDES.map((slide, index) => (
              ...
              >
                ...
                <div className="relative h-full flex flex-col p-8 md:p-16 lg:p-20 max-w-4xl pt-6 md:pt-10 lg:pt-12 pb-16 md:pb-0">
                  <h2 className="text-white text-2xl md:text-5xl lg:text-6xl font-black leading-[0.92] mb-5 tracking-tighter drop-shadow-2xl">
                    {slide.title.split('\n').map((line, i) => (
                  ...
                  {/* Espaciador que empuja el resto hacia abajo SOLO en móvil */}
                  <div className="flex-grow md:hidden"></div>

                  <div className="space-y-6 md:space-y-8">
                    <p className="text-white/90 text-[12px] md:text-base font-medium max-w-sm leading-relaxed drop-shadow-lg">
                      {slide.desc}
                    </p>
