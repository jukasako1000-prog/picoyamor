...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    name: 'Pack Olivo',
    price: 13.90,
    description: 'Columpio de sisal envuelto en ramitas de olivo natural. Ideal para aves medianas y pequeñas. Medidas: 22cm largo x 19cm ancho.',
  ...
  },
  {
    ...
    price: 13.50,
    description: 'Plataforma de madera natural con base de cuerda de yute tejida y cuentas geométricas. Diseño robusto y seguro para aves medianas y pequeñas. Medidas: 19cm alto x 14cm ancho.',
  ...
  },
  {
    ...
    price: 7.50,
    description: 'Columpio con cuentas de madera naturales forrada en cuerda de yute para mejor agarre. Pensado para aves pequeñas. Medidas: 24cm alto x 14cm ancho.',
  ...
  },
  {
    ...
    price: 7.50,
    description: 'Columpio de cuenta de madera y mazorca natural seca. Mosquetón de acero inoxidable para aves medianas y pequeñas. Medidas: 17cm alto x 14cm ancho.',
